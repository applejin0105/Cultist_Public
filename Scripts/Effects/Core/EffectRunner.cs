...
namespace Effects.Core
{
    ...
    public sealed class EffectRunner
    {
        ...
        /// initVars: TriggerContext.Vars 초기값 (예: {"isEcho" : 1}). cardsEffects.json의`{ "var": "isEcho" }` 토큰 해석에 사용.
        /// </summary>
